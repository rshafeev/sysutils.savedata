    ...
    if is_logging:
        if not os.path.isdir(logging_path):
             try:
                ...
                raise Exception("Error! Can not create path for logging files. Please, check configuration file: /etc/default/savedata.\nFinish.\n")
...
def prepare(work_path, args):
    ...
    if not os.path.isdir(work_path):
        raise Exception("Working path is not exists. Please, set existing working path in configuration file: /etc/default/savedata.\nFailed.\n")
    ...
    if not os.path.isdir(webdav_path):
        try:
            ...
            raise Exception("Error! Can not create path for mounting future webdav devices. Please, check configuration file: /etc/default/savedata.\nFailed.\n")       
    ...
    if not os.path.isdir(cache_path):
        try:
            ...
            raise Exception("Error! Can not create path for saving cache data. Please, check configuration file: /etc/default/savedata.\nFailed.\n")       
